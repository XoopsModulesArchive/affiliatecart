...
$xoopsOption['template_main'] = 'affiliatecart_singlelink.html';
include XOOPS_ROOT_PATH."/header.php";

$result = $xoopsDB->query("select l.lid, l.cid, l.title, l.url, l.logourl, l.status, l.date, l.hits, l.rating, l.votes, l.comments, t.description from ".$xoopsDB->prefix("affiliatecart_links")." l, ".$xoopsDB->prefix("affiliatecart_text")." t where l.lid=$lid and l.lid=t.lid and status>0");
